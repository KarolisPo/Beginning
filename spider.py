...
# version 1.1
# date: 2019.07.16
# description: starts on command line with url argument.
...
def find_links(html):
	...
	f = formatter.AbstractFormatter(writter)
...
class Spider:
	...
	process_page() retrievs each page and finds the links.
	...
	def run(self):
	# Processes lost of URLs one at a time
	...
	#Checks wether the link starts with the base URL
